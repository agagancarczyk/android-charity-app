...
public class Edit extends Activity implements Response<User> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Spinner nationalityView = (Spinner) findViewById(R.id.Nationality);
        for (int i = 1; i < nationalityView.getCount(); i++) {
            if (nationalityView.getItemAtPosition(i).toString()
                    .equals(app.currentUser.nationality)) {
            	nationalityView.setSelection(i);
            }
        }
    ...
    public void editButtonPressed(View view) {
        ...
        String userNationality = getSpinner(R.id.Nationality);
        app.currentUser.nationality=userNationality;
        String userRegion = getSpinner(R.id.Region);
        app.currentUser.region=userRegion;

        CharityServiceAPI.editUser(this, this, "Editing user", app.currentUser);
